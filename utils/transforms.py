...
class Resize:
    def __init__(self, image_size=(256,256)):
        '''
        crop images accroding to image_size
        '''
...
class RandomHorizontalFlip(object):
    def __init__(self, prob=0.5):
        '''
        Flip images from horizontal direction by prob probability
        '''
        self.prob = prob
...
class RandomVerticalFlip(object):
    def __init__(self, prob=0.5):
        '''
        Flip images from vertical direction by prob probability
        '''
        self.prob = prob
...
class RandomRotate:
    def __init__(self,prob=0.5,degree=[0,360]):
        '''
        Flip images to random degree from horizontal direction by prob probability
        '''
        self.prob=prob
        self.degree=degree
...
class ToTensor:
    def __init__(self):
        '''
        Transform the data type to Tensor type
        '''
        pass
